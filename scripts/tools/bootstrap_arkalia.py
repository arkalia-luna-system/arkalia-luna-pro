...
class ArkaliaBootstrap:
    ...
    def generate_recommendations(self) -> None:
        ...
        missing_packages = [
            k
            for k, v in python_checks.items()
        ...
        occupied_ports = [
            k for k, v in port_checks.items() if k.startswith("port_") and v.get("occupied", False)
        ]
        if occupied_ports:
        ...
        missing_services = [
            k
            for k, v in service_checks.items()
