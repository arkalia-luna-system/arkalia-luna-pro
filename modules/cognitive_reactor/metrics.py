...
cognitive_reactions_total = Counter(
    "cognitive_reactions_total", "Nombre total de réactions cognitives", ["reaction_type", "status"]
)
...
cognitive_learning_progress = Gauge(
    "cognitive_learning_progress", "Progression de l'apprentissage (0.0-1.0)", ["learning_type"]
)
