...
class ModuleFactory:
    ...
    def _register_default_modules(self) -> None:
        ...
        try:
            ...
            ark_logger.info("✅ Modules par défaut enregistrés", extra={"arkalia_module": "core"})
    ...
    def register_module_class(self, name: str, module_cls: type[IModule]) -> bool:
        ...
        ark_logger.info(f"Classe module enregistrée : {name}", extra={"arkalia_module": "core"})
        return True
    ...
    def create_module(self, name: str, **kwargs) -> IModule | None:
        ...
        try:
            ...
            ark_logger.info(f"Instance module créée : {name}", extra={"arkalia_module": "core"})
            return module
        except Exception as e:
            ark_logger.error(
